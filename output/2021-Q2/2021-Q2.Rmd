...
outcomes_by_ethnicity_model_text <- ifelse(
  ...
  str_glue(
    ...
    "the same across ethnicities – over the past 12 months, ", 
    ifelse(
...
Cover photo by [Roman Fox on Unsplash.com](https://unsplash.com/photos/nwt4QL2D_6o)
...
tweets[1] <- str_glue(
  ...
  "to June 2021 and shows the number of searches falling slightly to 275,000.",
  "\n\n#StopSearch Report: ",
  "http://lesscrime.info/publication/stop-and-search-london-2021-q2/\n\n",
...
tweets[9] <- str_glue(
  "The full report – created in #RStats using #OpenData – is available at ", 
  "http://lesscrime.info/publication/stop-and-search-london-2021-q2/\n\n",
  "We update the report every quarter to provide the latest analysis of ",
